...
```{r eval=T, comment=""}
g <- function(x=1, y = 2){ # set defaults to x and y
  x+y
}
g()       # 1 + 2
g(x=3)    # 3 + 2
...
... (dot-dot-dot)
<p style="font-size: 20px">Need to call functions in a function and additional arguments must be passed down</p>
